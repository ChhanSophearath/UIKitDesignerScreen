...
class TestingVC1: UIViewController{
...
class TestingVC2: UIViewController{
...
class TestingVC3: UIViewController{
    let button = UIButton(frame: CGRect(x: 0, y: 300, width: 300, height: 50))
...
class TestingVC4: UIViewController{
...
class TestingVC5: UIViewController, UIGestureRecognizerDelegate{
...
//        let viewController1 = TestingVC1()
//        let viewController2 = TestingVC2()
//        let viewController3 = TestingVC3()
//        let viewController4 = TestingVC4()
